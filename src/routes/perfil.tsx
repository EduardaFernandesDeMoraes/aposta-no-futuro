    ...
    <AppShell title="Perfil">
      ...
      <section className="rounded-3xl bg-gradient-to-br from-navy to-[#0f1a2e] p-6 text-white shadow-soft">
        <div className="flex items-center gap-4">
          <div className="grid h-16 w-16 place-items-center rounded-full bg-[#0d6b60] text-3xl text-white shadow-[inset_0_2px_6px_rgba(0,0,0,0.25)] ring-2 ring-white/10">
